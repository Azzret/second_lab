...
namespace _43_TextToHTML
{
    class ConcreteBuilder : Builder
    {
            ...
            public override string BuildPartA(RichTextBox Rtb)
            {
            ...
            public override string HTML_RGBHex(byte R, byte G, byte B)
            {
            ...
            public override string BuildPartC(RichTextBox Rtb)
            {
                // ---------------------------------- '' Инициализация переменных '' -----------------------------------
                int Spam = 0;
